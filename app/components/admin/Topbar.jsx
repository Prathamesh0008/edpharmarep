...
export default function Topbar({ onMenu }) {
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/80 backdrop-blur">
      <div className="px-4 py-3 sm:px-6 lg:px-8 flex items-center justify-between gap-3 sm:gap-4">
        {/* ================= LEFT ================= */}
        ...
        <div className="flex items-center gap-2 sm:gap-3 justify-end">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="hidden sm:block leading-tight">
              ...
              <div className="text-xs text-slate-500">admin@edpharma.com</div>
            </div>
          </div>
        </div>
      </div>
...
function StatusCard({ icon: Icon, label, value }) {
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-xl border border-slate-200 bg-white shadow-sm min-w-[150px]">
