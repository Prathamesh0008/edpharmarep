export const productImages = {
     "kamagra-gold-50-mg": {
   main: "/products/kamagra50_1.png",//public\products\kamagra50_1.png
    gallery: [
  ...
  "kamagra-gold-100-mg":{
    main: "/products/kamagra100_1.png",//public\products\kamagra100_1.png
    gallery: [
  ...
  "kamagra-100mg-oral-jelly-vol1":{
    main: "/products/kamagra_oral_jelly_1.png",//public\products\kamagra_oral_jelly_1.png
  gallery: [
  ...
  gallery: [
   ...
   "apcalis-sx-20mg-oral-jelly":{
    main: "/products/apcalis-sx-oral-jelly 2.png",//public\products\apcalis-sx-oral-jelly 2.png
  gallery: [
   ...
   "tadalis-sx-20mg":{
    main: "/products/Tadalis-SX-20mg.webp",
  gallery: [
   ...
   "lovegra-100mg-oral-jelly":{
    main: "/products/lovegra-oral-jelly-1.png",
  gallery: [
   ...
   "lovegra-100mg":{
    main: "/products/Lovegra-100mg_1.png",
  gallery: [
  ...
  gallery: [
   ...
   "cenforce-25mg":{
    main: "/products/cenforce-25-side.png",
  gallery: [
   ...
   "cenforce-50mg":{
    main: "/products/cenforce-50-mg-1-side 1.png",
   gallery: [
 ...
 gallery: [
   ...
   "cenforce-120mg":{
    main: "/products/cenforce_120_mg_1.webp",
 gallery: [
 ...
 gallery: [
   ...
   "cenforce-150mg":{
    main: "/products/cenforce 150_1.png",
   gallery: [
   ...
   "cenforce-200mg": {
    main: "/products/Cenforce 200_1.png",
   gallery: [
   ...
   "cenforce-soft-100":{
    main: "/products/Cenforce soft 100_1.png",
   gallery: [
   ...
   "cenforce-d-100-60": {
     main: "/products/cenforce-d_1.png",
   gallery: [
   ...
   "cenforce-fm-100mg":{
    main: "/products/cenforce-fm-100-mg-1.png",
 gallery: [
   ...
   "cenforce-oral-jelly-100mg":{
    main: "/products/Cenforce oral jelly.png",
   gallery: [
 ...
 gallery: [
   ...
   "vidalista-10mg":{
    main: "/products/vidalista-10-box.webp",
   gallery: [
   ...
   "vidalista-20mg":{
    main: "/products/Vidalista_1.webp",
 gallery: [
    ...
    "vidalista-40mg":{
       main: "/products/vidalista_40mg_1.webp",
 gallery: [
    ...
    "vidalista-60mg":{
      main: "/products/vidalista-60mg_1.webp",
 gallery: [
    ...
    "vidalista-80mg":{
      main: "/products/vidalista 80_1.webp",
 gallery: [
 ...
 gallery: [
    ...
    "super-vidalista-20-60":{
      main: "/products/super-vidalista_1.png",//public\products\Super-Kamagra-Oral-Jelly 3.png
  gallery: [
    ...
    "vidalista-ct-20mg":{
      main: "/products/vidalista20mg_1.webp",
  gallery: [
    ...
    "vidalista-professional-20mg":{
      main: "/products/vidalista-professional-20-mg_1.webp",
       gallery: [
  ...
  gallery: [
    ...
    "vilitra-20mg":{
         main: "/products/vilitra_20_2.webp",
 gallery: [
   ...
   gallery: [
    ...
    "vilitra-60mg":{
       main: "/products/Vilitra-60-Mg-2.webp",//public\products\Vilitra-60-Mg-2.webp
   gallery: [
    ...
    "super-vilitra":{
      main: "/products/super_vilitra_1.webp",//
   gallery: [
    ...
    "fliban-100mg":{
       main: "/products/fliban_2.png",//public\products\fliban_2.png
   gallery: [
    ...
    "avana-50mg":{
      main: "/products/Avana-50mg_1.png",//public\products\avanafil-avana-50mg-tablet_3.webp
  gallery: [
    ...
    "avana-100mg":{
      main: "/products/Avana-100mg_1.jpg",//public\products\Avana-100mg_2.png
  gallery: [
    ...
    "avana-200mg":{
       main: "/products/avana-200-mg-1000x1000.webp",//public\products\Avana 200_1.png
  gallery: [
    ...
    "top-avana":{
         main: "/products/Top avana_1.png",//public\products\TOP AVANA.png
   gallery: [
    ...
    "super-avana":{
      main: "/products/Super-Avana_3.png",//public\products\Super-Avana_3.png
  gallery: [
    ...
    "extra-super-avana":{
      main: "/products/extra super avan _1.png",//public\products\extra super avan _1.png
  gallery: [
    ...
    "poxet-30mg":{
    main: "/products/poxet-30-mg-1_1.png",//public\products\poxet-30-mg-1_2.png
  gallery: [
  ...
  gallery: [
    ...
    "/products/poxet-60_1.png",
     ...
     "poxet-90mg":{
      main: "/products/Poxet 90_2.png",//public\products\Poxet 90_2.png
  gallery: [
  ...
  gallery: [
   ...
   "p-force-fort":{
    main: "/products/p-force fort_1.png",//public\products\p-force fort_2.png
  gallery: [
  ...
  "p-force-plus":{
    main: "/products/P-Force-Plus_1.png",//public\products\P-Force-Plus_1.png
  gallery: [
   ...
   "super-p-force-oral-jelly":{
    main: "/products/Super-P-Force-Oral-Jelly15_1.png",//public\products\Super-P-Force-Oral-Jelly15_2.png
  gallery: [
   ...
   "super-p-force":{
    main: "/products/Super-P-Force6-sunrise_1.png",//public\products\Super-P-Force6-sunrise_2.png
  gallery: [
  ...
  "extra-super-p-force":{
    main: "/products/Extra-Super-P-Force_1.png",//public\products\Extra-Super-P-Force_1.png
  gallery: [
   ...
   "zhewitra-10":{
    main: "/products/zhewitra 10_1.png",
    gallery: [
  ...
  "zhewitra-20-oral-jelly":{
   main: "/products/zhewitra-20-oral-jelly_1.png",
     gallery: [
   ...
   "zhewitra-40":{
    main: "/products/zhewitra-40_1.png",
     gallery: [
   ...
   "zhewitra-60":{
   main: "/products/zhewitra-60_1.png",
   gallery: [
  ...
  "zhewitra-soft-20":{
   ...
   "super-zhewitra":{
   main: "/products/Super-Zhewitra16_1.png",//public\products\Super-Zhewitra16_1.png
    gallery: [
  ...
  "extra-super-zhewitra":{
   main: "/products/Extra-Super-Zhewitra_1.png",//public\products\Extra-Super-Zhewitra_1.png
    gallery: [
  ...
  "tadarise-2-5":{
   ...
   "tadarise-10":{
    main: "/products/tadarise10_1.png",//public\products\tadarise10_1.png
    gallery: [
  ...
  "tadarise-pro-20":{
   main: "/products/TADARISE PRO_20_1.png",
    gallery: [
   ...
   "tadarise-20":{
    main: "/products/TADARISE20_1.png",
    gallery: [
   ...
   main: "/products/tadalafil-oral-jelly-20-mg-1000x1000.png",//public\products\tadalafil-oral-jelly-20-mg-1000x1000.png
    gallery: [
    ...
    "tadarise-40":{
    main: "/products/tadarise40_1.png",//public\products\tadarise40_1.png
    gallery: [
  ...
  "tadarise-pro-40":{
   main: "/products/tadarise-pro-40_1.png",//public\products\tadarise-pro-40_1.png
    gallery: [
   ...
   "extra-super-tadarise":{
     main: "/products/extra_super_tadarise_tablet_1.png",
    gallery: [
 ...
 "tadarise-effervescent":{
  main: "/products/Tadarise-Effervescent_2.png",//public\products\Tadarise-Effervescent_2.png
    gallery: [
   ...
   "top-tadarise":{
    main: "/products/top-tadarise12-sunrise_1.png",
    gallery: [
  ...
  "tadasoft-20":{
    main: "/products/tadasoft-20-mg_1.png",//public\products\tadasoft-20-mg_3.png
  gallery: [
  ...
  gallery: [
   ...
   "sildisoft-100":{
    main: "/products/sildisoft-sildenafil-100_1.png",
    gallery: [
   ...
   "sildisoft-50":{
     main: "/products/sildisoft-sildenafil-50_1.png",
  gallery: [
  ...
  "malegra-25":{
   main: "/products/malegra_25_mg_1.png",
    gallery: [
   ...
   "malegra-50":{
   main: "/products/Malegra-50-Mg_2.webp",//public\products\malegra_50_mg_1.webp
    gallery: [
   ...
   "malegra-75":{
    main: "/products/malegra-sildenafil-tablets 75_2.png",//public\products\malegra-sildenafil-tablets 75_1.png
    gallery: [
   ...
   "malegra-200":{
   main: "/products/malegra-200_1.png",//public\products\malegra-200_2.png
    gallery: [
   ...
   "malegra-100-oral-jelly":{
    main: "/products/malegra_oral_jelly_1.webp",//public\products\malegra_oral_jelly_1.webp
    gallery: [
   ...
   "malegra-pro-50":{
     main: "/products/Malegra pro 50_1.png",///public\products\Malegra pro 50_1.png
    gallery: [
   ...
   "malegra-pro-100":{
    main: "/products/malegra pro 100_1.png",//public\products\malegra pro 100_1.png
    gallery: [
   ...
   "malegra-dxt":{
   main: "/products/Malegra-Dxt-100-30mg.png",//public\products\Malegra-Dxt.png public\products\Malegra-Dxt-100-30mg.png
    gallery: [
  ...
  "malegra-effervescent-100":{
    main: "/products/Malegra-100_1.png",//public\products\Malegra-100_2.png
    gallery: [
   ...
   "malegra-100-green":{
    main: "/products/Malegra-100 Green_2.png",
     gallery: [
  ...
  "penon-cream":{
   main: "/products/penon-cream-for-man-packaging-size-100-gm-1000x1000.png",
  gallery: [
   ...
   "naron-cream":{
   main: "/products/naron-cream_1.png",//public\products\naron-cream_1.png
    gallery: [
  ...
  "grafix-cream":{
   main: "/products/Grafix cream_1.png",//public\products\Grafix cream_2.png
    gallery: [
   ...
   "femallegra-100":{
    main: "/products/sildenafil-femalegra_1.png",//public\products\sildenafil-femalegra_2.png
    gallery: [
   ...
   "tadafem-20":{
    main: "/products/Tadafem 20_1.png",//public\products\Tadafem 20_2.png
    gallery: [
  ...
  gallery: [
    ...
    "zudena-100":{
     main: "/products/Zudena-100_3.png",
    gallery: [
   ...
   "super-zudena":{
   main: "/products/Super-Zudena.png",//public\products\Super-Zudena_3.png
    gallery: [
   ...
   "cinasun-30":{
    main: "/products/cinasun-30mg-tablets-1000x1000.png",//public\products\cinasun-30-3.png
    gallery: [
   ...
   "cinasun-90":{
   main: "/products/cinasun-90mg_1.png",//public\products\cinasun-90mg_2.png
    gallery: [
    ...
    "/products/cinasun-90mg_1.png",
     ...
     "chocolis-20":{
    main: "/products/chocolis-chewable-tadalafil-20mg-1000x1000.png",
    gallery: [
   ...
   "chocogra-100":{
    main: "/products/Chocogra 100.png",
    gallery: [
   ...
   "orlisun":{
   main: "/products/Orlisun-Orlistat.png",//public\products\Orlisun-Orlistat.png
    gallery: [
